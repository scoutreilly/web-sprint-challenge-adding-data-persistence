...
- I believe SQL databases are relational databases. Both use tables for data structure where non-relational use key: value pairs. SQL is used to query a relational database and they work for that reason

2. Why do tables need a Primary Key?

- To differentiate data. Tables should use them to link the data in a row when querying or doing one-to-many relationships
...
- A junction or associative table. This allows you to reference many different primary keys from the needed tables
